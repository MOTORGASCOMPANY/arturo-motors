                                        ...
                                        <div class="inline-flex items-center justify-end gap-1.5">
                                            ...
                                            <div class="relative inline-block group">
                                                ...
                                                <div class="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 hidden group-hover:flex flex-col items-center pointer-events-none z-10">
                                                    <span class="relative z-10 p-1.5 text-[10px] font-semibold leading-none text-white whitespace-nowrap bg-gray-800 rounded shadow-md">Ver detalle</span>
                                            ...
                                            @if ($orden->comprobante)
                                                <div class="relative inline-block group">
                                                    ...
                                                    <div class="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 hidden group-hover:flex flex-col items-center pointer-events-none z-10">
                                                        <span class="relative z-10 p-1.5 text-[10px] font-semibold leading-none text-white whitespace-nowrap bg-gray-800 rounded shadow-md">Ver PDF</span>
                                                        <div class="w-2 h-2 -mt-1 rotate-45 bg-gray-800"></div>
                                                    </div>
                                                </div>
                                            @endif
                                            @if ($orden->service->tipo === 'simple' && $orden->estado !== 'cancelada')
                                                <div class="relative inline-block group">
                                                    ...
                                                    <div class="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 hidden group-hover:flex flex-col items-center pointer-events-none z-10">
                                                        <span class="relative z-10 p-1.5 text-[10px] font-semibold leading-none text-white whitespace-nowrap bg-gray-800 rounded shadow-md">Cancelar</span>
                                                        <div class="w-2 h-2 -mt-1 rotate-45 bg-gray-800"></div>
                                                    </div>
                                                </div>
                                            @endif
