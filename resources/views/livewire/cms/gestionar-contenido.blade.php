        ...
        <div class="relative">
            ...
            @foreach ($sections as $section)
                ...
                <div
                    ...
                    <div class="flex flex-col {{ $hasImages ? 'lg:flex-row' : '' }} items-stretch">
                        ...
                        <div class="{{ $hasImages ? 'w-full lg:w-1/2 lg:border-r' : 'w-full' }} p-4 sm:p-6 border-b {{ $hasImages ? 'lg:border-b-0' : '' }} border-blue-100 bg-blue-50/35 flex flex-col">
                        ...
                        <div class="{{ $hasImages ? 'w-full lg:w-1/2' : 'w-full' }} p-4 sm:p-6 flex flex-col justify-between">
                            ...
                            <div class="bg-blue-50/50 rounded-xl p-3.5 sm:p-4 border border-blue-100 space-y-3">
                                ...
                                <div class="{{ $hasImages ? 'space-y-3' : 'grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4' }}">
                                    ...
                                    <div class="{{ $hasImages ? '' : 'md:col-span-2' }}">
                                    ...
                                    <div class="{{ $hasImages ? '' : 'md:col-span-2' }} flex justify-end pt-1">
