                            ...
                            @foreach ($productos as $p)
                                <tr wire:key="producto-{{ $p->id }}">
                                    ...
                                    <td class="px-4 py-3 text-right border-b border-gray-200 bg-white text-sm">
                                        ...
                                        <button wire:click="$dispatch('abrir-modal-editar-producto', { productoId: {{ $p->id }} })" type="button" class="text-gray-600 text-xs font-semibold mr-2">
                                            Editar →
                                        </button>
                                    ...
                                    <td class="px-4 py-2 border-b border-gray-200 bg-white text-sm text-right whitespace-nowrap">
                                        <div class="inline-flex items-center justify-end gap-1.5">
                                            <!-- Botón 3: Editar (Azul / Modificación) -->
                                            ...
                                            <!-- Botón 1: Registrar entrada (Verde / Entrada de inventario) -->
                                            <div class="relative inline-block group">
                                            ...
                                            <!-- Botón 2: Definir Componentes (Púrpura / Configuración de kit) -->
                                            @if ($p->categoria->es_kit)
                                                <div class="relative inline-block group">
