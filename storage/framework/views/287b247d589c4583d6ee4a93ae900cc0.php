...
<head>
    ...
    <style>
        ...
        body {
            ...
            font-size: 11pt;
            line-height: 1.4;
            background-image: url("<?php echo e(public_path('images/hoja_membretada.png')); ?>");
...
<body>
    <main class="contenido">
        ...
        <p>
            ...
            GARANTÍA DE 02 AÑOS DE LA INSTALACIÓN DEL EQUIPO DE GNV A SU AUTO, PLACA <strong><?php echo e($vehiculo->placa); ?></strong>,
...
<?php /**PATH C:\xampp\htdocs\arturo-motors\resources\views/pdfs/vehiculo.blade.php ENDPATH**/ ?>