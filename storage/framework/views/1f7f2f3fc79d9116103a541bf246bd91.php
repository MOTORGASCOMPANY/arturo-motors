<div class="container mx-auto py-12">
    <div class="bg-gray-200 p-8 rounded-xl w-full">
        ...
        <!-- Tabla de contratos -->
        <!--[if BLOCK]><![endif]--><?php if($contratos->count()): ?>
            <div class="overflow-x-auto">
                <table class="min-w-full leading-normal rounded-md overflow-hidden">
                    ...
                    <tbody>
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $contratos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b border-gray-200 bg-white text-sm" wire:key="contrato-<?php echo e($item->id); ?>">
                                ...
                                <td class="px-4 py-4 min-w-[140px]">
                                    <!--[if BLOCK]><![endif]--><?php if($item->vacaciones): ?>
                                        <?php
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3537859459-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\xampp\htdocs\Arturo\resources\views/livewire/r-r-h-h/contratos.blade.php ENDPATH**/ ?>