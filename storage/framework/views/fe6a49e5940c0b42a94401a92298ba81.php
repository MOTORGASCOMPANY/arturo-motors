...
<?php endif; ?>
         ...
         <?php $__env->slot('content', null, []); ?> 
            <?php if($periodo && count($lista_planilla) > 0): ?>
                ...
                <div class="mt-4 shadow-sm rounded-xl border border-gray-200 overflow-hidden">
                    <table class="min-w-full table-fixed divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-100 text-sm">
                            <?php $__currentLoopData = $lista_planilla; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\arturo-motors\resources\views\livewire\r-r-h-h\crear-planilla.blade.php ENDPATH**/ ?>