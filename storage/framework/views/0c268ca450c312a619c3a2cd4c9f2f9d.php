<div class="py-8 bg-gray-50 min-h-screen">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $planillas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year => $meses): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div x-data="{ openYear: <?php echo e($loop->first ? 'true' : 'false'); ?> }" class="mb-6 shadow-sm">
                ...
                <div x-show="openYear" x-collapse class="bg-white border-x border-b border-gray-200 rounded-b-xl p-4 sm:p-6 space-y-8">
                    <?php $__currentLoopData = $meses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mes => $periodos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <?php $__currentLoopData = $periodos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="relative p-4 rounded-xl border border-gray-100 bg-gray-50/50 hover:bg-white hover:shadow-md transition duration-200">
                                        ...
                                        <div class="space-y-2">
                                            <?php $__empty_2 = true; $__currentLoopData = $p->archivos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                <div class="flex items-center justify-between p-2 bg-white rounded-lg border border-gray-100 group">
                                                    <div class="flex items-center space-x-3 overflow-hidden">
                                                        <div class="w-8 h-8 flex-shrink-0 bg-gray-50 rounded flex items-center justify-center border">
                                                            <?php if(in_array($file->extension, ['jpg', 'jpeg', 'png'])): ?>
                                                    ...
                                                    <div class="flex items-center space-x-1">
                                                        ...
                                                        ?>
                                                        <?php if($file->tipo == 'boleta' && !$yaFirmado): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1026655755-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\xampp\htdocs\arturo-motors\resources\views\livewire\r-r-h-h\mis-planillas.blade.php ENDPATH**/ ?>