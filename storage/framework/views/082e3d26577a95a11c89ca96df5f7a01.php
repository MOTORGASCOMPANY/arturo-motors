                    ...
                    <div class="bg-gray-50 dark:bg-gray-800 rounded-xl p-8 border border-gray-200 dark:border-gray-700 min-h-[200px] flex items-center justify-center">
                        <!--[if BLOCK]><![endif]--><?php if($currentLogo): ?>
                            <div class="relative max-w-full max-h-[180px]">
                                <picture>
                                    <!--[if BLOCK]><![endif]--><?php if($currentLogo->webpUrl()): ?>
    ...
    <script>
        function confirmRemoveLogo() {
            Swal.fire({
                ...
                if (result.isConfirmed) { window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('removeLogo') }
            });
        }
        function confirmRemoveFavicon() {
            Swal.fire({
                ...
                if (result.isConfirmed) { window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('removeFavicon') }
            });
        }
    </script>
 <?php echo $__env->renderComponent(); ?>
