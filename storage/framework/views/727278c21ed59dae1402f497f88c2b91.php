...
<div x-data="{ open: false, search: '' }" class="relative" @click.outside="open = false">
    ...
    <div x-show="open"
        ...
        <div class="p-3 max-h-64 overflow-y-auto">
            <?php $__currentLoopData = $icons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $iconList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div>
                    <p class="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-2 mt-3 first:mt-0"><?php echo e($category); ?></p>
                    <div class="grid grid-cols-4 gap-1.5">
                        <?php $__currentLoopData = $iconList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iconClass => $iconLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button type="button"
