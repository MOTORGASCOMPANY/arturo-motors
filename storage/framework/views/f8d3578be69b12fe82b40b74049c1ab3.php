<div class="container mx-auto py-12 px-2">
    <div class="bg-gray-200 rounded-lg shadow-sm p-4">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <div class="flex bg-gray-50 items-center p-2 rounded-md mb-4">
                        <select wire:model.live="periodoSeleccionado" class="bg-gray-50 mx-2 border-indigo-500 rounded-md outline-none text-sm">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $listaPeriodos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <!-- Tabla de planillas -->
        <!--[if BLOCK]><![endif]--><?php if($planillas->count()): ?>
            <div class="overflow-x-auto bg-white rounded-lg border border-gray-300">
                <table class="min-w-full leading-normal">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $planillas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-2 py-3 w-52 min-w-[220px] max-w-[280px]">
                                    <div class="flex flex-col gap-1">
                                        <!--[if BLOCK]><![endif]--><?php if($item->observacion): ?>
                                        ...
                                        <div class="flex flex-wrap gap-1">
                                            <!--[if BLOCK]><![endif]--><?php if($item->asignacion_familiar > 0): ?>
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($item->horas_extras > 0): ?>
                                                <span class="px-1.5 py-0.5 bg-blue-100 text-blue-700 rounded text-[10px] font-bold whitespace-nowrap">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($item->movilidad > 0): ?>
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($item->otros_ingresos > 0): ?>
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($item->otros_descuentos > 0): ?>
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if(!$item->observacion && $item->asignacion_familiar == 0 && $item->horas_extras == 0 && $item->movilidad == 0 && $item->otros_ingresos == 0 && $item->otros_descuentos == 0): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1479512289-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1479512289-1', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\xampp\htdocs\Arturo\resources\views/livewire/r-r-h-h/lista-planilla.blade.php ENDPATH**/ ?>