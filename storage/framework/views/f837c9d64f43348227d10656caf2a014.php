...
$__html = app('livewire')->mount($__name, $__params, 'lw-1396385151-0', $__slots ?? [], get_defined_vars());
                    ...
                    <table class="min-w-full leading-normal rounded-md overflow-hidden">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $permisos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr wire:key="permiso-<?php echo e($item->id); ?>">
                                    ...
                                    <td class="px-6 py-4 border-b border-gray-200 bg-white text-sm">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-3">
                                                <p class="text-gray-900 font-bold"><?php echo e($item->name); ?></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 border-b border-gray-200 bg-white text-sm">
...
<?php /**PATH C:\xampp\htdocs\arturo-motors\resources\views\livewire\admin-permisos.blade.php ENDPATH**/ ?>