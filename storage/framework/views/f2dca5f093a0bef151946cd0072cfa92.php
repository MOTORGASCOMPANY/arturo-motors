    ...
    <aside x-show="sidebarOpen" x-transition:enter="transition ease-in-out duration-300" x-transition:enter-start="opacity-0 -translate-x-full" x-transition:enter-end="opacity-100 translate-x-0" x-transition:leave="transition ease-in-out duration-300" x-transition:leave-start="opacity-100 translate-x-0" x-transition:leave-end="opacity-0 -translate-x-full" class="fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 transform lg:translate-x-0" :class="{ 'translate-x-0': sidebarOpen, '-translate-x-full': !sidebarOpen }" @keydown.escape.window="sidebarOpen = false" aria-label="Navegación principal">
        ...
        <div class="flex flex-col h-full">
            <div class="p-5 border-b border-gray-200 dark:border-gray-700">
                <a href="<?php echo e(route('landing')); ?>" class="flex items-center gap-3 text-gray-900 dark:text-white hover:opacity-80 transition-opacity" aria-label="Arturo Motors - Ir al inicio">
            ...
            <div class="p-4 border-t border-gray-200 dark:border-gray-700">
                <a href="<?php echo e(route('landing')); ?>" target="_blank" class="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200 text-sm font-medium hover:bg-gray-200 dark:hover:bg-gray-700 transition-all" @click="sidebarOpen = false">
        ...
        <main class="p-4 sm:p-6 lg:p-8">
            ...
            <div class="mb-8">
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-3">
                    <?php echo $headerIcon ?? '<i class="fa-solid fa-cog text-blue-600"></i>'; ?>

                    <?php echo e($title ?? 'Gestión CMS'); ?>

                </h2>
                <p class="text-gray-500 dark:text-gray-400 mt-1"><?php echo e($description ?? 'Administra el contenido del landing page'); ?></p>
            </div>
...
</div><?php /**PATH C:\xampp\htdocs\arturo-motors\resources\views/components/cms/layout.blade.php ENDPATH**/ ?>