...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div
                            ...
                            <div class="flex items-center space-x-4">
                                <div
                                    ...
                                    <?php if(in_array($archivo->getClientOriginalExtension(), ['jpg', 'jpeg', 'png'])): ?>
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-lg p-2 shadow-sm">
                    ...
                    <div class="space-y-4">
                        <?php $__currentLoopData = ['comprobante', 'boleta', 'boleta_firmada']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div>
                                <h4 class="text-[10px] font-black text-gray-700 uppercase tracking-widest mb-2 border-b pb-1"> <?php echo e($t); ?></h4>
                                <div class="space-y-3">
                                    <?php $__empty_1 = true; $__currentLoopData = $planilla->archivos->where('tipo', $t); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\arturo-motors\resources\views\livewire\r-r-h-h\planilla-archivos.blade.php ENDPATH**/ ?>