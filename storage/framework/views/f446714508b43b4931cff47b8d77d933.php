...
<?php endif; ?>
            <select id="repuesto_id" class="bg-white border-gray-300 rounded-md outline-none ml-1 block w-full"
                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $repuestosDisponibles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $repuesto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if(count($repuestos) > 0): ?>
                ...
                <div class="py-2 inline-block min-w-full ">
                    <div class="overflow-hidden rounded-lg">
                        <table class="min-w-full">
                            ...
                            <tbody>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $repuestos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\Lifegas\resources\views/livewire/solicitud-repuestos.blade.php ENDPATH**/ ?>