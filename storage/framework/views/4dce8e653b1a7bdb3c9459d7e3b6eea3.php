...
<head>
    <meta charset="utf-8">
    <title>Comprobante <?php echo e($orden->comprobante->folio); ?></title>
    <style>
        @page {
            margin: 20px 25px;
        }
    ...
    <table class="header-table w-100">
        <tr>
            ...
            <td style="width: 58%; padding-right: 10px;">
                <img src="<?php echo e(public_path('images/arturo3.png')); ?>" class="logo">
            ...
            <td style="width: 42%; vertical-align: top;">
                <div class="ruc-box">
                    ...
                    <div class="ruc-folio"><?php echo e($orden->comprobante->folio); ?></div>
                </div>
            </td>
        </tr>
    </table>
    ...
    <div class="section-box">
        ...
        <table class="data-table w-100">
            <tr>
                ...
                <td class="val" style="width: 32%;"><?php echo e($orden->cliente->nombre); ?> <?php echo e($orden->cliente->apellido); ?></td>
                <td class="label">Fecha / Hora:</td>
                <td class="val" style="width: 32%;"><?php echo e($orden->comprobante->created_at->format('d/m/Y H:i')); ?></td>
            </tr>
            <tr>
                <td class="label">Documento:</td>
                <td class="val"><?php echo e($orden->cliente->documento ?? '74859612'); ?></td>
                <td class="label">Método Pago:</td>
                <td class="val"><?php echo e(ucfirst($orden->comprobante->metodo_pago)); ?></td>
            </tr>
            <tr>
                <td class="label">Placa Vehículo:</td>
                <td class="val"><strong style="font-size: 11px; color: #1e3a8a;"><?php echo e(strtoupper($orden->vehiculo->placa)); ?></strong></td>
                <td class="label">Marca/Modelo:</td>
                <td class="val"><?php echo e($orden->vehiculo->marca); ?> <?php echo e($orden->vehiculo->modelo); ?></td>
            </tr>
            <tr>
    ...
    <table class="items-table w-100">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <strong><?php echo e($orden->service->nombre); ?></strong>
                    <?php if(!empty($orden->descuento_motivo)): ?>
                        <br><span style="font-size: 8.5px; color: #64748b;">Ajuste: <?php echo e($orden->descuento_motivo); ?></span>
                    <?php endif; ?>
                </td>
                <td class="text-center">1</td>
                <td class="text-right">S/ <?php echo e(number_format($orden->comprobante->monto, 2)); ?></td>
                <td class="text-right">S/ <?php echo e(number_format($orden->comprobante->monto, 2)); ?></td>
            </tr>
        </tbody>
    </table>
        ...
        <tr>
            ...
            <td style="width: 55%; vertical-align: top; padding-top: 6px;">
                <div style="font-size: 9.5px; color: #334155;">
                    ...
                    Son <?php echo e(number_format($orden->comprobante->monto, 2)); ?> Soles.
                </div>
            </td>
            ...
            <td style="width: 45%;">
                <table class="w-100">
                    <tr>
                        ...
                        <td class="text-right" style="width: 40%; padding: 2px 4px;">S/ <?php echo e(number_format($orden->comprobante->monto / 1.18, 2)); ?></td>
                    </tr>
                    <tr>
                        <td class="text-right font-bold" style="color: #475569; padding: 2px 4px;">I.G.V. (18%):</td>
                        <td class="text-right" style="padding: 2px 4px;">S/ <?php echo e(number_format($orden->comprobante->monto - ($orden->comprobante->monto / 1.18), 2)); ?></td>
                    </tr>
                    <tr class="total-row">
                        <td class="text-right font-bold" style="padding: 5px 4px; color: #0f172a;">TOTAL A PAGAR:</td>
                        <td class="text-right font-bold" style="padding: 5px 4px; color: #1e3a8a;">S/ <?php echo e(number_format($orden->comprobante->monto, 2)); ?></td>
                    </tr>
                </table>
            </td>
        </tr>
...
</html><?php /**PATH C:\xampp\htdocs\Arturo\resources\views/pdfs/comprobante.blade.php ENDPATH**/ ?>