...
<head>
    <meta charset="UTF-8">
    <title>Contrato de Trabajo - <?php echo e($contrato->user->name); ?></title>
    <style>
        @page {
            margin: 1.2cm 1.5cm;
        }
...
<body>
    <p class="header">
        <img src="<?php echo e(public_path('/images/arturo3.png')); ?>" width="300" height="100" />
    </p>
    ...
    <div class="content">
        ...
        CONTRATANTE <span class="bold"><?php echo e($contrato->user->name); ?></span>
        y por el otro parte identificado con DNI <span class="bold"><?php echo e($contrato->user->dni); ?></span> , domiciliada en
        <?php echo e($contrato->user->direccion); ?>,
    ...
    <div class="content">
        ...
        entre los días <span
            class="bold"><?php echo e($contrato->fecha_inicio_contrato->translatedFormat('d \d\e F \d\e\l Y')); ?></span> al
        <span class="bold"><?php echo e($contrato->fecha_vencimiento->translatedFormat('d \d\e F \d\e\l Y')); ?></span>.
    </div>

    <div class="content">
        <span class="bold">SEGUNDO:</span> EL CONTRATADO cumplirá las funciones de <span
            class="bold"><?php echo e($contrato->cargo); ?></span> en el proceso de Certificaciones
    ...
    <div class="content">
        ...
        <?php echo e(number_format($contrato->sueldo_bruto, 2)); ?> (<?php echo e($sueldo_letras); ?>)</span>, en forma mensual por la integridad de
    ...
    <div class="content" style="margin-top: 20px;">
        ...
        <span class="bold"><?php echo e($contrato->fecha_inicio_contrato->format('d')); ?></span> días de
        <span class="bold"><?php echo e($contrato->fecha_inicio_contrato->translatedFormat('F')); ?></span>
        del año <span class="bold"><?php echo e($contrato->fecha_inicio_contrato->format('Y')); ?></span>.
    </div>
            ...
            <tr>
                <td>
                    <div class="signature-container">
                        <img src="<?php echo e(public_path('images/firmaing.jpeg')); ?>" class="firma-img">
                ...
                <td>
                    <div class="signature-container">
                        <div class="line"></div>
                        <span class="bold"><?php echo e($contrato->user->name); ?></span><br>
                        <span style="font-size: 10px;">DNI: <?php echo e($contrato->user->dni); ?></span><br>
...
<?php /**PATH C:\xampp\htdocs\arturo-motors\resources\views\pdfs\contrato_laboral.blade.php ENDPATH**/ ?>