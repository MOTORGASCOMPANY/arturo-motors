                ...
                <div class="overflow-x-auto bg-white rounded-lg shadow">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <?php $__currentLoopData = $expedientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="text-center">
                                        <div class="flex justify-center items-center space-x-2">
                                            ...
                                            <?php if (\Illuminate\Support\Facades\Blade::check('hasanyrole', 'Administrador del sistema|Vendedor|Jefe de Taller')): ?>
...
<?php endif; ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
                        <?php $__currentLoopData = $tiposDocumentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="p-4 border border-gray-200 rounded-lg shadow-sm">
                                ...
                                <div id="file-upload-container-<?php echo e($tipo->id); ?>"
                                    ...
                                    <div class="space-y-1 text-center">
                                        ...
                                        <?php if(!isset($documentoNuevo[$tipo->id]) && $files->where('tipo_documento_id', $tipo->id)->isEmpty()): ?>
                                    ...
                                    <!-- Existentes (DB) -->
                                    <?php $__currentLoopData = $files->where('tipo_documento_id', $tipo->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="relative w-full mb-2">
                                            <?php
                                                $extension = pathinfo($fil->ruta, PATHINFO_EXTENSION);
                                            ?>
                                            <?php if(in_array($extension, ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'tif', 'tiff'])): ?>
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <!-- Nuevos (temporal) -->
                                    <?php if(isset($documentoNuevo[$tipo->id]) && is_array($documentoNuevo[$tipo->id])): ?>
                                        <?php $__currentLoopData = $documentoNuevo[$tipo->id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $otro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="relative w-full mb-2">
                                                <?php
                                                    $extension = pathinfo(
...
<?php endif; ?>
                    ...
                    <div class="flex flex-col md:flex-row mt-4 border rounded-lg">
                        ...
                        <div class="flex-1">
                            ...
                            <?php $__currentLoopData = $accesorios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $display_name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\arturo-motors\resources\views\livewire\lista-expedientes.blade.php ENDPATH**/ ?>