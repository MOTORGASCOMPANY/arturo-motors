...
<?php $component->withAttributes([]); ?>
             <?php $__env->slot('titulo', null, []); ?> 
                <h2 class="text-blue-600 font-bold text-3xl flex items-center gap-2">
                    <i class="fa-solid fa-user-tag fa-xl text-blue-600"></i>
                    Roles
                </h2>
             <?php $__env->endSlot(); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3997230210-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\xampp\htdocs\Arturo\resources\views/livewire/admin-roles.blade.php ENDPATH**/ ?>