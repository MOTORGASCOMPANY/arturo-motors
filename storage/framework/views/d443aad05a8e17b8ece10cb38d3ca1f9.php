...
<?php endif; ?>
            ...
            <div class="flex flex-col md:flex-row mt-4 border rounded-lg">
                ...
                <div class="flex-1">
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $accesorios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accesorio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\Lifegas\resources\views/livewire/expediente-modal.blade.php ENDPATH**/ ?>