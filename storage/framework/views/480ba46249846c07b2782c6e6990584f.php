...
$__html = app('livewire')->mount($__name, $__params, 'lw-2897305088-0', $__slots ?? [], get_defined_vars());
                    ...
                    <table class="min-w-full leading-normal rounded-md overflow-hidden">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr wire:key="role-<?php echo e($item->id); ?>">
                                    ...
                                    <td class="px-6 py-4 border-b border-gray-200 bg-white text-sm">
                                        <div class="flex flex-wrap gap-1 items-center">
                                            <?php $__empty_1 = true; $__currentLoopData = $item->permissions->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permiso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            ...
                                            <?php endif; ?>
                                            <?php if($item->permissions->count() > 3): ?>
                                                <button wire:click="verPermisos(<?php echo e($item->id); ?>)"
                                    ...
                                    <td class="px-6 py-4 border-b border-gray-200 bg-white text-sm">
                                        <div class="flex flex-col">
                                            <span class="font-medium text-gray-900"><?php echo e(optional($item->created_at)->format('d/m/Y')); ?></span>
                                            <span class="text-xs text-gray-500"><?php echo e(optional($item->created_at)->format('h:i A')); ?></span>
                                        </div>
                                    </td>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal49bd1c1dd878e22e0fb84faabf295a3f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal49bd1c1dd878e22e0fb84faabf295a3f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dialog-modal','data' => ['wire:model' => 'openPermisos','wire:loading.attr' => 'disabled']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dialog-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'openPermisos','wire:loading.attr' => 'disabled']); ?>
         <?php $__env->slot('title', null, []); ?> 
            <h1 class="text-xl font-bold"><i class="fa-solid fa-key text-white"></i> &nbsp;Permisos de <?php echo e($rolNombre); ?></h1>
         <?php $__env->endSlot(); ?>

         <?php $__env->slot('content', null, []); ?> 
            <div class="flex flex-wrap gap-2">
                <?php $__currentLoopData = $rolPermisos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permiso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         ...
         <?php $__env->slot('footer', null, []); ?> 
            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => '$set(\'openPermisos\', false)','class' => 'mx-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => '$set(\'openPermisos\', false)','class' => 'mx-2']); ?>
                Cerrar
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af)): ?>
...
<?php /**PATH C:\xampp\htdocs\arturo-motors\resources\views\livewire\admin-roles.blade.php ENDPATH**/ ?>