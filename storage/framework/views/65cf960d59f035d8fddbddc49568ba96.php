...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cms.layout','data' => ['title' => 'Redes Sociales','description' => 'Administra los enlaces a redes sociales que se muestran en el footer del landing page','headerIcon' => '<i class="fa-brands fa-instagram text-blue-600"></i>']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Redes Sociales','description' => 'Administra los enlaces a redes sociales que se muestran en el footer del landing page','headerIcon' => '<i class="fa-brands fa-instagram text-blue-600"></i>']); ?>
    
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8 pb-4 border-b border-blue-100">
        <div>
            
            <h2 class="text-xl font-semibold text-blue-950"><?php echo e(count($links)); ?> redes sociales</h2>
                ...
                <div class="p-6 flex-1">
                    <div class="flex items-start justify-between mb-4">
                        <div class="w-12 h-12 rounded-xl bg-blue-50 flex items-center justify-center text-blue-600 border border-blue-100 group-hover:bg-blue-600 group-hover:text-white transition-colors duration-300">
                            <i class="<?php echo e($link['icon'] ?? $platformIcons[$link['platform']] ?? 'fa-solid fa-link'); ?> text-xl"></i>
                        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cms.status-badge','data' => ['active' => $link['is_active']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($link['is_active'])]); ?>
...
<?php endif; ?>
                    ...
                    <h5 class="font-bold text-blue-950 text-lg mb-1 capitalize group-hover:text-blue-700 transition-colors"><?php echo e($link['platform']); ?></h5>
                    <p class="text-slate-600 text-sm break-all"><?php echo e(Str::limit($link['url'], 50)); ?></p>
                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cms.action-button','data' => ['icon' => 'fa-solid fa-pen','variant' => 'warning','wireClick' => 'edit('.e($link['id']).')','title' => 'Editar']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'fa-solid fa-pen','variant' => 'warning','wireClick' => 'edit('.e($link['id']).')','title' => 'Editar']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginald33697478d33dbb46e4d5cecf0cf51f9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald33697478d33dbb46e4d5cecf0cf51f9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cms.action-button','data' => ['icon' => 'fa-solid fa-'.e($link['is_active'] ? 'eye-slash' : 'eye').'','variant' => ''.e($link['is_active'] ? 'ghost' : 'success').'','onclick' => 'confirmToggleLink('.e($link['id']).')','title' => ''.e($link['is_active'] ? 'Desactivar' : 'Activar').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('cms.action-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'fa-solid fa-'.e($link['is_active'] ? 'eye-slash' : 'eye').'','variant' => ''.e($link['is_active'] ? 'ghost' : 'success').'','onclick' => 'confirmToggleLink('.e($link['id']).')','title' => ''.e($link['is_active'] ? 'Desactivar' : 'Activar').'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald33697478d33dbb46e4d5cecf0cf51f9)): ?>
<?php $attributes = $__attributesOriginald33697478d33dbb46e4d5cecf0cf51f9; ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginald33697478d33dbb46e4d5cecf0cf51f9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald33697478d33dbb46e4d5cecf0cf51f9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cms.action-button','data' => ['icon' => 'fa-solid fa-trash','variant' => 'danger','onclick' => 'confirmDeleteLink('.e($link['id']).')','title' => 'Eliminar']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('cms.action-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'fa-solid fa-trash','variant' => 'danger','onclick' => 'confirmDeleteLink('.e($link['id']).')','title' => 'Eliminar']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald33697478d33dbb46e4d5cecf0cf51f9)): ?>
<?php $attributes = $__attributesOriginald33697478d33dbb46e4d5cecf0cf51f9; ?>
        ...
        <div class="fixed inset-0 bg-blue-950/20 backdrop-blur-sm flex items-center justify-center z-50 overflow-y-auto py-8 px-4" x-data="{}" x-init="$watch('showForm', v => { if(v) document.body.style.overflow = 'hidden'; else document.body.style.overflow = ''; })">
            <div class="bg-white rounded-2xl shadow-2xl shadow-blue-900/10 w-full max-w-xl max-h-[90vh] overflow-y-auto" style="animation: modalFadeIn 0.3s ease-out">
                <div class="sticky top-0 bg-white border-b border-blue-100 px-6 py-4 flex justify-between items-center rounded-t-2xl z-10">
                    <h4 class="text-lg font-bold text-blue-950"><?php echo e($editingId ? 'Editar' : 'Nueva'); ?> Red Social</h4>
                            ...
                            <div class="relative" x-data="{ open: false }">
                                ...
                                <button type="button"
                                    ...
                                    <div class="w-9 h-9 shrink-0 rounded-lg bg-blue-50 border border-blue-100 flex items-center justify-center text-blue-600 text-base">
                                        <i class="<?php echo e($currentIcon ?: 'fa-solid fa-link'); ?>"></i>
                                    </div>

                                    <span class="flex-1 text-sm text-blue-950 truncate">
                                        <?php echo e($currentIcon ? ($socialIconOptions[$currentIcon] ?? 'Ícono personalizado') : 'Selecciona un ícono...'); ?>
                                ...
                                <div x-show="open"
                                    ...
                                    <div class="grid grid-cols-5 sm:grid-cols-6 gap-2">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $socialIconOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iconClass => $iconLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <button type="button"
                                                    wire:click="$set('icon', '<?php echo e($iconClass); ?>')"
                                                    @click="open = false"
                                                    title="<?php echo e($iconLabel); ?>"
                                                    class="aspect-square rounded-lg border flex items-center justify-center text-lg transition-all <?php echo e($currentIcon === $iconClass ? 'bg-blue-600 text-white border-blue-600' : 'bg-blue-50/50 text-blue-600 border-blue-100 hover:bg-blue-100 hover:border-blue-300'); ?>">
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\arturo-motors\resources\views/livewire/cms/gestionar-redes.blade.php ENDPATH**/ ?>