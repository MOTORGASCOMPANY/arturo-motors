...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginald33697478d33dbb46e4d5cecf0cf51f9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald33697478d33dbb46e4d5cecf0cf51f9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cms.action-button','data' => ['icon' => 'fa-solid fa-'.e($link['is_active'] ? 'eye-slash' : 'eye').'','variant' => ''.e($link['is_active'] ? 'ghost' : 'success').'','wireClick' => 'toggleActive('.e($link['id']).')','title' => ''.e($link['is_active'] ? 'Desactivar' : 'Activar').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('cms.action-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'fa-solid fa-'.e($link['is_active'] ? 'eye-slash' : 'eye').'','variant' => ''.e($link['is_active'] ? 'ghost' : 'success').'','wireClick' => 'toggleActive('.e($link['id']).')','title' => ''.e($link['is_active'] ? 'Desactivar' : 'Activar').'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald33697478d33dbb46e4d5cecf0cf51f9)): ?>
<?php $attributes = $__attributesOriginald33697478d33dbb46e4d5cecf0cf51f9; ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginald33697478d33dbb46e4d5cecf0cf51f9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald33697478d33dbb46e4d5cecf0cf51f9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cms.action-button','data' => ['icon' => 'fa-solid fa-trash','variant' => 'danger','wireClick' => 'delete('.e($link['id']).')','title' => 'Eliminar']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('cms.action-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'fa-solid fa-trash','variant' => 'danger','wireClick' => 'delete('.e($link['id']).')','title' => 'Eliminar']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald33697478d33dbb46e4d5cecf0cf51f9)): ?>
<?php $attributes = $__attributesOriginald33697478d33dbb46e4d5cecf0cf51f9; ?>
