    ...
    <div class="pb-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex bg-gray-50 items-center p-2 rounded-md">
                <span>Mostrar</span>
                <select wire:model="cant" class="bg-gray-50 mx-2 border border-blue-500 rounded-md outline-none w-20">
            ...
            <div class="flex bg-gray-50 items-center p-2 rounded-md">
                <span>Estado:</span>
                <select wire:model.live="es" class="bg-gray-50 mx-2 border border-blue-500 rounded-md outline-none w-40">
            ...
            <div class="flex bg-gray-50 items-center lg:w-3/6 p-2 rounded-md">
                ...
                <input type="text" wire:model.live="search"
                    class="bg-gray-50 outline-none rounded-md border border-blue-500 w-full ml-2"
                    placeholder="Buscar...">
            </div>
        </div>
        <!-- Tabla -->
...
<?php /**PATH C:\xampp\htdocs\arturo-motors\resources\views\components\table-expedientes.blade.php ENDPATH**/ ?>