            ...
            <div class="rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800" x-data="colorPreview()" x-init="init()" :style="previewStyle">
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <?php $__currentLoopData = ['primary' => 'Primario', 'secondary' => 'Secundario', 'accent' => 'Acento']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="space-y-5">
                    <?php $__currentLoopData = [
                        ...
                        <div>
                            ...
                            <?php $__errorArgs = ["colors.<?php echo e($key); ?>"];
